...
<div class="wrap">
	...
	<?php
		...
		$login_background_color = isset($options['login_background_color']) ? $options['login_background_color'] : '';
		$login_button_primary_color = isset($options['login_button_primary_color']) ? $options['login_button_primary_color'] : '';
 ...
 <!-- Login page customizations -->
    ...
    <h2><?php _e('Login customization', $this->plugin_name);?></h2>
